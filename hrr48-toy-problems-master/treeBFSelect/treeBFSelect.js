...
Tree.prototype.BFSelect = function(filter) {
  ...
  // iterate through all the sibling node values to see if they return true
    // if they do, push that into the result array
  //  then starting with the first child, do it again

  var BFSearch = function(nodes, depth) {
    ...
    for (var m = 0; m < nodes.length; m++) {
      if (nodes[m].children.length !== 0) {
        BFSearch(nodes[m].children, depth + 1);
      }
    }
  }
