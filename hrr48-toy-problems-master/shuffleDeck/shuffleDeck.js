 ...
 */
 ...
 // I: given an ordered "deck" as an array
 // O: a shuffled "deck" as an array
 // C: constant IF we can assume they will always enter a full 52 card deck, as specified by testing function
 // E:
var shuffleDeck = function(deck) {
  ...
  while (deckLength) {
    deck.push(deck.splice(Math.floor(Math.random() * deckLength), 1)[0]);
    deckLength--;
  }
